    ...
    <div class="flex flex-wrap items-center justify-between gap-3 p-4">
      <div class="flex min-w-0 items-center gap-2">
        ...
        <div class="min-w-0">
          <button
            type="button"
            class="block truncate text-left font-medium text-gray-900 hover:text-blue-600 hover:underline dark:text-white dark:hover:text-blue-400"
            @click="emit('navigate')"
          >
      ...
      <button
        ...
        type="button"
        :disabled="disabled"
        class="rounded bg-blue-600 px-3 py-1.5 text-sm text-white hover:bg-blue-700 disabled:cursor-not-allowed disabled:opacity-50"
    ...
    <div v-if="expanded" class="space-y-3 border-t border-gray-200 p-4 dark:border-gray-700">
      <div class="flex flex-wrap items-center justify-between gap-2">
        ...
        <button
          ...
          type="button"
          :disabled="disabled"
          class="rounded border border-blue-600 px-3 py-1 text-sm text-blue-600 hover:bg-blue-50 disabled:cursor-not-allowed disabled:opacity-50 dark:text-blue-400 dark:hover:bg-gray-700"
