...
<template>
  <div class="w-full">
    ...
    <div class="mx-auto max-w-6xl p-6">
      ...
      <div v-if="!heroImageSrc" class="mb-8">
        <nav class="breadcrumbs mb-4 text-sm">
          <router-link to="/books" class="text-gold-600 hover:text-gold-700">Books</router-link>
          <span class="mx-2 text-gray-500">></span>
          <router-link :to="bookWikiUrl" class="text-gold-600 hover:text-gold-700">
            {{ bookTitle }}
          </router-link>
          <span class="mx-2 text-gray-500">></span>
            ...
            <div class="flex-1">
              ...
              <div v-if="isEditingPageName" class="flex items-center space-x-2">
                ...
                <button
                  @click="savePageName"
                  :disabled="saving"
                  class="px-3 py-2 bg-gold-600 text-white rounded hover:bg-gold-700 disabled:opacity-50 transition-colors"
                >
                  Save
                </button>
                <button
        ...
        <div v-if="wikiPage" class="flex items-center space-x-3">
          <button
            ...
            :class="wikiPage.is_pinned
              ? 'bg-gold-100 text-gold-700 hover:bg-gold-200 dark:bg-gold-900 dark:text-gold-300 dark:hover:bg-gold-800'
          ...
          <template v-if="isEditing">
            ...
            <button
              @click="saveChanges"
              :disabled="saving"
              class="px-3 py-2 bg-gold-600 text-white rounded-md hover:bg-gold-700 disabled:opacity-50 disabled:cursor-not-allowed transition-colors inline-flex items-center"
            >
        ...
        <div>
          <div v-if="isEditingPageName" class="flex items-center space-x-2">
            <input
              ...
              @keyup.esc="cancelEditPageName"
              type="text"
              class="text-xl font-bold bg-white dark:bg-gray-700 text-gray-900 dark:text-white border border-gray-300 dark:border-gray-600 rounded px-2 py-1 focus:outline-none focus:ring-2 focus:ring-gold-500"
              placeholder="Page name"
              autofocus
            />
            <button
              @click="savePageName"
              :disabled="saving"
              class="px-2 py-1 bg-gold-600 text-white text-sm rounded hover:bg-gold-700 disabled:opacity-50"
            >
              Save
            </button>
            <button
      ...
      <div class="flex items-center space-x-2">
        ...
        <template v-if="isEditing">
          ...
          <button
            @click="saveChanges"
            :disabled="saving"
            class="px-2 py-1.5 text-sm bg-gold-600 text-white rounded-md hover:bg-gold-700 disabled:opacity-50 inline-flex items-center"
          >
    ...
    <div v-else-if="wikiPage" class="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div class="p-6">
            ...
            <div v-if="isEditing" class="space-y-4">
              <textarea
                ...
                rows="20"
                class="w-full p-4 border border-gray-300 dark:border-gray-600 rounded-md bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:ring-2 focus:ring-gold-500 focus:border-transparent resize-y"
      ...
      <div class="space-y-6">
        ...
        <!-- History -->
        <div v-if="isHistoryFeatureEnabled && showHistory" class="bg-white dark:bg-navy-800 rounded-lg shadow-md border border-gray-200 dark:border-gray-700">
          <div class="p-6">
            ...
            <div v-else-if="wikiHistory.length > 0" class="space-y-3">
              <div
                ...
                :key="update.id"
                class="border-l-4 border-gold-200 pl-4 py-2"
              >
                <div class="flex items-center justify-between">
                ...
                <p v-if="update.chapter_title" class="text-xs text-gold-600 dark:text-gold-400 mt-1">
  ...
  <div v-if="showDeleteModal" class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
      <div class="bg-white dark:bg-navy-800 rounded-lg p-6 w-full max-w-md mx-4 shadow-xl">
