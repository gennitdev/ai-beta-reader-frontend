    ...
    <div v-else-if="chapter" class="space-y-6">
          ...
          <div v-else-if="chapter.summary || isEditingSummary" class="space-y-4 text-sm">
              ...
              <div class="flex justify-between items-center mb-2">
                ...
                <div v-if="isEditingSummary" class="flex items-center space-x-2">
                  ...
                  >
                    <span
                      v-if="savingSummary"
                      class="animate-spin rounded-full h-3 w-3 border border-white border-t-transparent mr-1"
                    ></span>
            ...
            <div v-if="chapter.characters && chapter.characters.length">
              ...
              <div class="flex flex-wrap gap-1">
                <button
                  ...
                  @click="
                    navigateToWiki(typeof character === 'string' ? character : character.name)
                  "
                  :class="[
                    'inline-block px-2 py-1 text-xs rounded transition-colors',
                    getCharacterWikiInfo(typeof character === 'string' ? character : character.name)
                      ?.has_wiki_page
            ...
            <div v-if="chapter.beats && chapter.beats.length">
              ...
              <ul class="text-gray-700 dark:text-gray-300 space-y-1">
                <li v-for="beat in chapter.beats" :key="beat" class="text-xs">• {{ beat }}</li>
              </ul>
            </div>
          </div>
      ...
      >
        <div class="p-6">
          ...
          <!-- Empty state -->
          <div v-else-if="savedReviews.length === 0 && !loadingReviews" class="text-center py-8 text-gray-500 dark:text-gray-400">
          ...
          <!-- Reviews list -->
          <div v-else-if="savedReviews.length > 0" class="space-y-6">
            <div
              ...
              <div class="prose prose-sm prose-gray dark:prose-invert max-w-none">
                <template
                  v-if="
                    ...
                    getTruncatedText(review.review_text).needsTruncation
                  "
                >
              ...
              >
                ...
                <div v-else class="space-y-3">
                  ...
                  <div class="bg-gray-50 dark:bg-gray-700 rounded-lg p-4 text-sm">
                    <pre
                      class="whitespace-pre-wrap text-gray-800 dark:text-gray-200 font-mono text-xs leading-relaxed"
                      >{{ review.prompt_used }}</pre
                    >
                  </div>
                </div>
              </div>
